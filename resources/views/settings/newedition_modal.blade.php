 <!-- Create Item Modal -->
    <div class="modal fade" id="create-edition" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <form class="formedition" action="{{ route('editions-data.store') }}" method="POST">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="myModalLabel">{{ trans('title.addedition') }}</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary crud-edition-submit" value="{{ trans('adminlte_lang::message.submit') }}">
            </div>
        </div>
        </form>
    </div>
